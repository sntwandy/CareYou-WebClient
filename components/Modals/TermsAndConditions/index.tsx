...
import { ITermsConditionsModal } from '../../../utils/interfaces';

const WarningToConfirm: FC<ITermsConditionsModal> = (
  props: ITermsConditionsModal
): ReactElement => {
  /* Destructuring Props */
  const {
    termsConditionsModal,
    setTermsConditionsModal,
  ...
  return (
    <div className={'fixed z-10 inset-0 overflow-y-auto'}>
      ...
      >
        ...
        <div
          className={`${modalStyle} rounded-tl-input rounded-br-input inline-block align-bottom bg-secondary text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full`}
          role={'dialog'}
          aria-modal="true"
        ...
        >
            ...
            <div className={'sm:flex sm:items-start'}>
              ...
              <div className={'mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'}>
                ...
                <p>
                  ...
                  of this pre-diagnosis, in which its veracity{' '}
                  <span className={'text-termsConditions'}>
                    IS NOT 100% AUTHENTIC
                  </span>{' '}
                  and may contain biases; We recommend that you contact a health
                  professional to verify the result of this pre-diagnosis.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <button
              type={'button'}
              className={
                'w-full inline-flex text-secondary justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary text-base font-medium hover:text-primaryButtonHover focus:outline-none focus:ring-2 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm'
              }
              onClick={() => {

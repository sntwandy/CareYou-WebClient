  ...
  return (
    <div className={'flex w-full h-full items-center justify-center flex-col'}>
      <figure className={'w-20 h-20 mb-6'}>
        <img className={'w-full'} src={'https://i.imgur.com/gcjciRd.png'} alt={'Login img'} />
      </figure>
      <div className={'mb-6'}>
      ...
      <div className={'flex items-center justify-center flex-col'}>
        <div className={'flex items-center justify-center flex-col mb-3.5'}>
          ...
          <div className={'absolute w-5 h-primaryInput pt-4 ml-52 flex items-center justify-end'}>
            <img className={'w-5'} src={'https://i.imgur.com/eQCr5cP.png'} alt={'Login input'}/>
          </div>
        </div>
        <div className={'flex items-center justify-center flex-col mb-1'}>
          ...
          <div className={'absolute w-5 h-primaryInput pt-4 ml-52 flex items-center justify-end'}>
            <img className={'w-5'} src={'https://i.imgur.com/SjG6uz1.png'} alt={'Login input'}/>
          </div>
        </div>
